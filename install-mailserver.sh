...
echo "📬 Webmail: http://localhost/rainloop"
echo "🔧 Admin panel: https://localhost:10000 (login: root atau sudo user)"
...
echo "🔑 RainLoop admin: http://localhost/rainloop/?admin (user: admin, pass: 12345)"
